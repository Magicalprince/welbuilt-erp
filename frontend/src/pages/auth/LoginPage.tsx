      ...
      >
        ...
        <Card className="glass-card border-white/10 shadow-2xl">
          <CardContent className="p-8">
            ...
            >
              <p className="text-muted-foreground">Sign in to your WelBuilt account</p>
            </motion.div>
              ...
              >
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="login-input pl-10 border-primary/30 placeholder:text-slate-400 focus:border-primary focus:ring-primary/20"
                    required
                  />
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="login-input pl-10 pr-10 border-primary/30 placeholder:text-slate-400 focus:border-primary focus:ring-primary/20"
                    required
                  />
                  <button
                    type="button"
